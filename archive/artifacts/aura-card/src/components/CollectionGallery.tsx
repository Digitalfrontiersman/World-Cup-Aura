...
import { X, Loader2, ThumbsUp, MessageSquare, Layers } from "lucide-react";
        ...
        >
          ...
          <div className="shrink-0 border-b border-white/10 bg-background/80 backdrop-blur-md">
            <div className="mx-auto flex w-full max-w-6xl items-center justify-between gap-4 px-4 py-4">
              ...
              <button
                onClick={onClose}
                className="grid h-9 w-9 shrink-0 place-items-center rounded-lg bg-white/[0.06] text-white transition-colors hover:bg-white/10"
