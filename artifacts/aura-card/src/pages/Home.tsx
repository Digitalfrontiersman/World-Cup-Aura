...
export default function Home() {
  ...
  return (
    <div className="min-h-[100dvh] w-full bg-background relative overflow-hidden font-sans select-none text-foreground">
      ...
      <main className={`relative z-10 mx-auto w-full min-h-[100dvh] flex flex-col pt-8 pb-12 px-4 ${step === 'result' ? 'max-w-4xl' : step === 'landing' ? 'max-w-md md:max-w-6xl' : 'container max-w-md'}`} style={{ paddingLeft: 'max(1rem, env(safe-area-inset-left))', paddingRight: 'max(1rem, env(safe-area-inset-right))' }}>
